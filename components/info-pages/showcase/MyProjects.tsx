...
function ShuffledProjectGroup({ category, description, children }: { category: string; description: string; children: React.ReactNode }) {
    return (
    ...
    return (
        <Box entryDelay={entryDelay}>
            ...
            <div className="flex flex-col w-full gap-1 h-96 overflow-y-auto">
                <ShuffledProjectGroup category="Games" description="Desktop and web video games">
                ...
                <ShuffledProjectGroup category="Visualisation" description="Data transformation and abstraction">
                ...
                <ShuffledProjectGroup category="Websites" description="Web designed projects">
                ...
                <ShuffledProjectGroup category="Libraries" description="Collections of common code">
                ...
                <ShuffledProjectGroup category="APIs" description="Application programming interfaces">
                ...
                <ShuffledProjectGroup category="Mods" description="Minecraft and Vintage Story game mods">
                ...
                <ShuffledProjectGroup category="Hardware" description="Integrated devices and embedded">
